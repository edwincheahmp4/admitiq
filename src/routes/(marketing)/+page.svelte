      ...
      <div class="card bg-white shadow-xl rounded-2xl flex-1">
        <div class="card-body flex flex-col items-center text-center p-8">
          <div class="text-lg font-bold text-[#2d174d] mb-2">
            ...
            <span class="font-normal text-base text-gray-500">($60/hr)</span>
          </div>
          <div class="text-[#2d174d] mb-4">
            Help your child familiarize themselves with essential foundations
            for core IB subjects with affordable rates. By providing free access
            to high scoring IAs, past papers, and subject notes - your child
...
<div class="py-16 bg-base-100 bg-primary/10">
  <div class="max-w-5xl mx-auto px-4">
    <div class="text-center mb-10">
      <div
        id="free-guides"
        class="text-3xl md:text-4xl font-bold text-[#2d174d] mb-2"
      >
